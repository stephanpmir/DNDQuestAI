...
const ITEM_DB: ItemInfo[] = [
  ...
  { name: "longsword", description: "A versatile sword with a long blade, effective in one or two hands.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u2694\uFE0F", basePrice: 15 },
  { name: "shortsword", description: "A light, nimble blade ideal for quick strikes. Uses finesse.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F5E1}\uFE0F", basePrice: 10 },
  { name: "greatsword", description: "A massive two-handed sword that deals heavy slashing damage.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u2694\uFE0F", basePrice: 50 },
  { name: "rapier", description: "An elegant, thin blade favored by duelists. Uses finesse.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F5E1}\uFE0F", basePrice: 25 },
  { name: "scimitar", description: "A curved blade designed for swift, sweeping cuts. Uses finesse.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F5E1}\uFE0F", basePrice: 25 },

  // ── Axes ──
  { name: "greataxe", description: "A heavy two-handed axe favored by barbarians.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1FA93}", basePrice: 30 },
  { name: "handaxe", description: "A light, throwable axe suitable for melee or ranged attacks.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1FA93}", basePrice: 5 },
  { name: "battleaxe", description: "A versatile axe that can be wielded with one or two hands.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1FA93}", basePrice: 10 },

  // ── Blunt ──
  { name: "mace", description: "A heavy bludgeoning weapon with a flanged metal head.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F528}", basePrice: 5 },
  { name: "warhammer", description: "A heavy hammer built for crushing armor and bone.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F528}", basePrice: 15 },
  { name: "flail", description: "A spiked ball on a chain, difficult to block with a shield.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F528}", basePrice: 10 },
  { name: "morningstar", description: "A spiked mace that deals piercing damage on impact.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F528}", basePrice: 15 },
  { name: "maul", description: "An enormous two-handed hammer that delivers crushing blows.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F528}", basePrice: 10 },

  // ── Polearms ──
  { name: "spear", description: "A simple polearm that can be thrown or used in melee.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F531}", basePrice: 1 },
  { name: "javelin", description: "A light throwing spear designed for ranged attacks.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F531}", basePrice: 1 },
  { name: "trident", description: "A three-pronged spear, versatile and throwable.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F531}", basePrice: 5 },
  { name: "halberd", description: "A polearm with an axe blade, spike, and hook. Has reach.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F531}", basePrice: 20 },
  { name: "pike", description: "A long spear designed for holding formations. Has reach.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F531}", basePrice: 5 },
  { name: "glaive", description: "A curved blade on a long pole. Has reach.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F531}", basePrice: 20 },
  { name: "lance", description: "A jousting weapon that deals heavy damage on a charge.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F531}", basePrice: 10 },

  // ── Small / misc weapons ──
  { name: "dagger", description: "A small, concealable blade. Light and throwable, uses finesse.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1F5E1}\uFE0F", basePrice: 2 },
  { name: "quarterstaff", description: "A simple wooden staff, versatile in combat.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1FA84}", basePrice: 1 },
  { name: "whip", description: "A flexible weapon with reach and finesse.", isMagical: false, category: "weapon", slot: "weapon", icon: "\u{1FA83}", basePrice: 2 },

  // ── Ranged ──
  { name: "longbow", description: "A tall bow requiring strength and skill. Effective at long range.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F3F9}", basePrice: 50 },
  { name: "shortbow", description: "A compact bow ideal for skirmishing and mounted combat.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F3F9}", basePrice: 25 },
  { name: "crossbow", description: "A mechanical ranged weapon. Simple to use but slow to reload.", isMagical: false, category: "weapon", slot: "weapon", twoHanded: true, icon: "\u{1F3F9}", basePrice: 50 },
  ...
  // ── Magical weapons ──
  { name: "+1 longsword", description: "A finely crafted sword with a faint magical aura.", isMagical: true, magicalProperties: "+1 bonus to attack and damage rolls.", category: "weapon", slot: "weapon", icon: "\u2694\uFE0F", basePrice: 1000 },
